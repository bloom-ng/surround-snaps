...
<body>
    <div class="flex flex-col bg-white">
        ...
        <nav id="menu" class="hidden flex flex-col items-start p-4 bg-white ml-4">
                <a href="/" class="font-normal font-lato text-base text-black">HOME</a>
            ...
            <div class="flex flex-col justify-center items-center w-full">
                <div class="bg-[#F4845F] lg:mt-0 mt-0 flex flex-col justify-center lg:w-full w-full py-7 lg:py-7 px-8 lg:px-14">
                    <div class="flex flex-row justify-between lg:mb-6">
                        <div>
                            <p class="text-white font-lato font-bold text-3xl lg:text-4xl">Payment</p>
                        </div>
                    ...
                    <div class="flex flex-col bg-white rounded-2xl mb-5 px-14 py-7 w-full">
                        <h1 class=" text-[#F4845F] text-2xl lg:text-3xl font-lato justify-center text-center font-bold mb-64">Please Select Your Preffered Payment Method</h1>
                    </div>
                </div>
            </div>
        </div>

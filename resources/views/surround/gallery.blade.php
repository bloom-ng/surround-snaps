...
@section('content')
    ...
    <div class="flex flex-col h-full w-full bg-[url('/images/decor.jpg')] bg-cover bg-center bg-no-repeat">
        ...
        <div class="flex flex-col items-center w-full h-full">
            <div class="flex flex-col w-full bg-[#1b998b] py-10 lg:px-10 lg:py-10 md:px-10 md:py-10">
                <div class="w-full py-20 px-8 lg:px-20 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-16">

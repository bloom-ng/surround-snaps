    ...
    <div class="flex flex-col bg-white">
        ...
        <div class="hidden md:flex flex-row w-[100%] justify-between">
            ...
            {{-- <div class="flex flex-row justify-between items-center lg:w-[50%] md:w-[60%]">
                <a href="/"
                    class="font-normal font-lato lg:text-base @if (request()->is('/')) text-[#1b998b] @endif">HOME</a>
                ...
                <a href="/gallery"
                    class="font-normal font-lato lg:text-base @if (request()->is('gallery')) text-[#1b998b] @endif">GALLERY</a>
                <a href="/contact"
                    class="font-normal font-lato lg:text-base @if (request()->is('contact')) text-[#1b998b] @endif">CONTACT
                    US</a>
            </div> --}}
            {{-- <div
                class="flex flex-row md:w-[20%] lg:w-[30%] justify-center items-center font-montserrat font-extrabold md:text-base lg:text-lg">
                <a href="/booking">
                    <div class="bg-[#F4845F] text-white lg:px-8 lg:py-1 md:px-4 md:py-1 lg:ml-44 rounded-2xl">BOOK NOW
                    </div>
                </a>
            </div> --}}
        </div>
        ...
        {{-- <nav id="menu" class="hidden flex flex-col items-start p-4 bg-white font-semibold ml-4">
            <a href="/"
                class="pb-2 font-normal font-lato text-base @if (request()->is('/')) text-[#1b998b] @else text-black @endif">HOME</a>
            ...
            <a href="/gallery"
                class="py-2 font-normal font-lato text-base @if (request()->is('gallery')) text-[#1b998b] @else text-black @endif">GALLERY</a>
            <a href="/contact"
                class="py-2 font-normal font-lato text-base @if (request()->is('contact')) text-[#1b998b] @else text-black @endif">CONTACT
                US</a>
        </nav> --}}
        <!-- /mobile header -->

        <div class="w-full min-h-[80vh] h-full flex items-center justify-center bg-gray-50">
                    ...
                    <div class="rounded-md shadow-sm">
                        <div class="my-5">
                            ...
                            <input id="email-address" name="email" type="email" autocomplete="email" required
                                class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-[#1b998b] focus:border-[#1b998b] focus:z-10 sm:text-sm"
                        ...
                        <div class="my-5">
                            ...
                            <input id="password" name="password" type="password" autocomplete="current-password"
                                required
                                class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-[#1b998b] focus:border-[#1b998b] focus:z-10 sm:text-sm"
                                placeholder="Password">
                        </div>
                    </div>
                    <div>
                        <button type="submit"
                            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#1b998b] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1b998b]">
                            Sign in
                        </button>
                    </div>
                </form>
        ...
        <footer class="flex flex-col">
            <div
                class="flex lg:flex-row md:flex-row flex-col lg:justify-between md:justify-between w-[100%] lg:items-center">
                ...
                <div
                    class="flex lg:flex-row md:items-center lg:items-center md:flex-row flex-col lg:w-1/2 md:w-1/2 md:justify-end lg:justify-end lg:mr-14 lg:ml-0 md:mr-12 md:ml-0 ml-10 lg:mb-0 mb-3">
                    <a href="">
                        <p class="lg:mr-7 md:mr-5 font-lato">Privacy Policy</p>
                    </a>
                    <a href="">
                        <p class="font-lato">Terms of Service</p>
                    </a>
                </div>
            </div>
            ...
            <div class="flex md:flex-row md:items-center lg:flex-row flex-col ml-10 lg:ml-10 lg:items-center mb-5">
                <div class="flex flex-row">
                    <a href="https://www.instagram.com/surroundsnaps360?igsh=MWR1M2diNzljenQ3aA=="><svg width="46"
                            ...
                            <defs>
                                <pattern id="pattern0_1721_189" patternContentUnits="objectBoundingBox"
                                    width="1" height="1">
                                    <use xlink:href="#image0_1721_189" transform="scale(0.0111111)" />
                                </pattern>
                                <image id="image0_1721_189" width="90" height="90"
                    ...
                    <a href=""><svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <rect width="36" height="36" fill="url(#pattern0_1721_190)" />
                            <defs>
                                <pattern id="pattern0_1721_190" patternContentUnits="objectBoundingBox"
                                    width="1" height="1">
                                    <use xlink:href="#image0_1721_190" transform="scale(0.0111111)" />
                                </pattern>
                                <image id="image0_1721_190" width="90" height="90"
                    ...
                    <a href="https://m.yelp.com/biz/surround-snaps-douglasville">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="46" height="34" version="1.1" id="Layer_1"
                ...
                <p class="lg:mb-3 font-lato"><strong>Stay in the Loop</strong> - Get updates on promotions and new
                    features follow us on socials.</p>
